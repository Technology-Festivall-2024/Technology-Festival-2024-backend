...
export interface ApiEventEvent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    heldIn: Attribute.String;
    heldOn: Attribute.DateTime;
    groupLink: Attribute.String;
    festival: Attribute.Relation<
      'api::event.event',
      'manyToOne',
      'api::festival.festival'
    >;
    eventable: Attribute.DynamicZone<
      ['eventable.competition', 'eventable.seminar']
    > &
      Attribute.Required &
      Attribute.SetMinMax<
        {
        ...
        number
      >;
    eventRegistrations: Attribute.Relation<
      'api::event.event',
      'oneToMany',
      'api::event-registration.event-registration'
    >;
    milestones: Attribute.Component<'event.milestone', true> &
      Attribute.Required;
    contactPerson: Attribute.Component<'event.contact-person', true> &
      Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiEventRegistrationEventRegistration
  ...
  attributes: {
    ...
    > &
      Attribute.Required &
      Attribute.DefaultTo<'Registration Pending'>;
    ...
    event: Attribute.Relation<
      ...
      'api::event.event'
    >;
    submission: Attribute.Component<'event.submission'>;
    payment: Attribute.Component<'event.payment'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::event-registration.event-registration',
...
export interface ApiParticipantParticipant extends Schema.CollectionType {
  ...
  attributes: {
    ...
    festival: Attribute.Relation<
      ...
      'api::festival.festival'
    >;
    provider: Attribute.Enumeration<['Credentials', 'Google', 'GitHub']>;
    eventRegistrations: Attribute.Relation<
      'api::participant.participant',
      'manyToMany',
      'api::event-registration.event-registration'
